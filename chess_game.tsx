...
const isValidPawnMove = (startRow: number, startCol: number, endRow: number, endCol: number, piece: Piece, board: Board): boolean => {
...
const getAllLegalMoves = (board: Board, color: Player): Move[] => {
    const moves: Move[] = [];
...
const getLegalMoves = (piece: Piece, row: number, col: number, board: Board): Position[] => {
...
const isCheckmate = (board: Board, color: Player): boolean => {
...
const isStalemate = (board: Board, color: Player): boolean => {
    if (isInCheck(board, color)) return false;
